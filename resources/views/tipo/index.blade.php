...
@section('contenido')
 ...
 <div class="container section-title" data-aos="fade-up">
  <h2>Tipo de Anemia</h2>
  <p>Para conocer el tipo de anemia que podrías tener,
    por favor ingresa tus datos a continuación.</p>
</div><!-- End Section Title -->

<div class="container" data-aos="fade-up" data-aos-delay="100">
<form method="post" role="form" id="predictionForm2">
    @csrf
    <input type="hidden" name="content" id="content">
    <div class="row" style="align-content: center,center">
        <div class="col-md-6 form-group mt-3 mt-md-0">
            <label for="dni">DNI (8 dígitos)</label>
            <input type="number" name="dni" class="form-control" id="dni"   oninput="validateLength(this)" placeholder="DNI (8 dígitos)" required>
            @error('dni')
    ...
    <div class="row">
        <div class="col-md-4 form-group">
            ...
            <input type="number" name="edad" class="form-control" step="0.01" id="edad" placeholder="Edad (mes)"  required>
            @error('edad')
                <div class="alerta_perso">{{ $message }}</div>
            @enderror
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4 form-group mt-3 mt-md-0">
            <label for="rbc">RBC (3.8 - 6.1 millones/µL)</label>
            <input type="number" step="0.01" name="rbc" class="form-control" id="rbc" placeholder="RBC"  required>
            @error('rbc')
                <div class="alerta_perso">{{ $message }}</div>
            @enderror
        </div>
    ...
    <div class="row">
        <div class="col-md-4 form-group">
            ...
            <input type="number" step="0.01" name="mcv" class="form-control" id="mcv" placeholder="MCV"  required>
            @error('mcv')
                <div class="alerta_perso">{{ $message }}</div>
            @enderror
        </div>
        <div class="col-md-4 form-group mt-3 mt-md-0">
            ...
            <input type="number" step="0.01" class="form-control" name="mch" id="mch" placeholder="MCH"  required>
            @error('mch')
                <div class="alerta_perso">{{ $message }}</div>
            @enderror
        </div>
        <div class="col-md-4 form-group mt-3 mt-md-0">
            ...
            <input type="number" step="0.01" class="form-control" name="mchc" id="mchc" placeholder="MCHC"  required>
            @error('mchc')
                <div class="alerta_perso">{{ $message }}</div>
            @enderror
        </div>
    ...
    <div class="row">
        <div class="col-md-4 form-group mt-3 mt-md-0">
            ...
            <input type="number" step="0.01" class="form-control" name="rdw" id="rdw" placeholder="RDW"  required>
            @error('rdw')
                <div class="alerta_perso">{{ $message }}</div>
            @enderror
        </div>
    ...
    <div class="mt-3 text-center">
        ...
        <script>
            ...
            document.getElementById('predictionForm2').addEventListener('submit', function (event) {
                ...
                // Validar RBC
                if (isNaN(rbc) || rbc < 3.8 || rbc > 6.1) {
                    Swal.fire({
                        title: 'Error de Validación',
                        text: "Ingresa los datos del recuento de globulos rojos (RBC) dentro del rango de 3.8 y 6.1",
                        icon: 'error',
                        confirmButtonText: 'Aceptar'
                    }).then(() => {
                        rbcInput.value = '';
                ...
                $.ajax({
                    url: "{{ route('tipo_p') }}", // Ruta del controlador
                    method: 'POST',
                    headers: {
                    ...
                    success: function(response) {
                        ...
                        setTimeout(() => {  
                            Swal.close();
                            Swal.fire({
                                title: 'Predicción del Tipo de Anemia',
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (result.isConfirmed) {
                    ...
                    if (result.isConfirmed) {
                        ...
                        var hmg = $("#hmg").val();
                        var tipo_prediccion = $("#tipo_prediccion").val();
                        ...
                        Sexo: ${sexo}, 
                        HMG: ${hmg}, 
                        Tipo de Prueba: ${tipo_prediccion == 1 ? 'Anemia' : (tipo_prediccion == 2 ? 'Severidad' : 'Tipo de Anemia')}, 
                        ...
                        data: {
                            "content": contentText, // Datos enviados en la solicitud (el contenido del formulario en formato de texto)
                            "phone": result.value // Número de celular
                        }
